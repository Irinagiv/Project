...
namespace ElcutCRM.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            if (BusinessContext.UserManager.Verify(model.UserName,model.Password))
            {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    var user = BusinessContext.UserManager.Create(model.UserName, model.Password);
                    BusinessContext.UserManager.Save(user);
